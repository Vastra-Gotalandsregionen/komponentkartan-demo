...
import { IDropdownItem } from 'vgr-komponentkartan/component-package/models/dropdownItem.model';
import { ISelectableItem } from 'vgr-komponentkartan/component-package/models/selectableItem.model';
import { ModalService, ModalButtonConfiguration } from 'vgr-komponentkartan/component-package/services/modalService';
import { IHeaderMenu, IHeaderMenuItem } from 'vgr-komponentkartan/component-package/models/headerMenu.model';
import { NotificationType } from 'vgr-komponentkartan/component-package/models/notificationType.model';
import { NotificationIcon } from 'vgr-komponentkartan/component-package/models/notificationIcon.model';
...
export class KomponentkartaComponent implements AfterViewInit {
    ...
    private selectedThemeChanged(selectedTheme: ISelectableItem) {
        ...
        $('app-komponentkartan').removeClass('theme--blue theme--red theme--neutral theme--green');
        $('app-komponentkartan').addClass(themeClass);
