...
var KomponentkartaComponent = (function () {
    function KomponentkartaComponent(modalService) {
        ...
        setTimeout(function () {
            _this.dropDownItems25All = _this.getDemoItems(25);
        }, 1000);
    ...
    KomponentkartaComponent.prototype.onActionStarted = function () {
        this.actionPanelMessage = '';
        this.actionInProgress = true;
    };
    KomponentkartaComponent.prototype.onActionEnded = function () {
        this.actionInProgress = false;
    };
