...
export class CardComponent implements OnInit {
  ...
  <div class="card__top flex-row">
    <vgr-save-cancel class="flex-right" [secondary]="true"
      (unlock)="unlocked = true" (save)="unlocked = false" (cancel)="unlocked = false"></vgr-save-cancel>
  </div>
  <vgr-card-section class="card__left" [expanded]="true" [title]="'Rubrik'" [subtitle]="'Personuppgifter'" [readonly]="!unlocked">
  ...
  <vgr-card-section class="card__right" [expanded]="true" [title]="'Rubrik'" [subtitle]="'Adressuppgifter'">
    <div class="title-value-layout ">
  ...
  <vgr-card-section class="card__left" [expanded]="false" [title]="'Rubrik'" [subtitle]="'Övrig information'">
    <span>Innehåll</span>
  </vgr-card-section>
</vgr-card>`;
